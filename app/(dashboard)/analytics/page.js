    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-slate-900/60">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-xs text-slate-400 font-semibold uppercase">Maintenance Tickets</p>
              <h3 className="text-2xl font-black text-amber-400 mt-1">{data?.summary?.totalMaintenance || 0}</h3>
            </div>
        ...
        <Card className="bg-slate-900/60">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-black text-purple-300 mt-1">{data?.summary?.completionRate || 0}%</h3>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <span>Weekly Booking & Ticket Activity</span>
            </CardTitle>
            <CardDescription>Comparing amenity reservations to maintenance dispatches</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <span>Maintenance Resolution Status Breakdown</span>
            </CardTitle>
            <CardDescription>Current state of work order tickets</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            <span>Amenity Reservation Demand</span>
          </CardTitle>
          <CardDescription>Most frequently booked community facilities</CardDescription>
        </CardHeader>
        <CardContent>
